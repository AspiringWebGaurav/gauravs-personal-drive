...
export function FolderBreadcrumb({ 
  ...
  if (isMobile) {
    return (
      <nav className="flex items-center justify-between w-full bg-card/50 backdrop-blur-sm rounded-lg p-2 mb-4">
        <div className="flex items-center space-x-2 flex-1 min-w-0">
          ...
          {currentFolder && (
            <Button
              ...
              className="h-8 px-2 font-medium hover:text-foreground flex items-center flex-shrink-0"
            >
